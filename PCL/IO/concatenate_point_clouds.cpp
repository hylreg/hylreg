...
main(int argc, char **argv) {
    ...
    if (strcmp(argv[1], "-p") == 0)
        ...
        for (std::size_t i = 0; i < n_cloud_b.size(); ++i)
            std::cerr << "    " << n_cloud_b[i].normal[0] << " " << n_cloud_b[i].normal[1] << " " << n_cloud_b[i].normal
                    [2] << std::endl;
    ...
    if (strcmp(argv[1], "-p") == 0) {
        ...
        for (std::size_t i = 0; i < p_n_cloud_c.size(); ++i)
            std::cerr << "    " <<
                    ...
                    p_n_cloud_c[i].normal[0] << " " << p_n_cloud_c[i].normal[1] << " " << p_n_cloud_c[i].normal[2] <<
                    std::endl;
    }
    return (0);
}
