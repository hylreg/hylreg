...
main (int argc, char** argv)
{
  ...
  narf_keypoint_detector.setRadiusSearch(10);
  narf_keypoint_detector.getParameters ().support_size = 10.0f;
  narf_keypoint_detector.getParameters ().min_interest_value = 0.5f;

  narf_keypoint_detector.getParameters ().add_points_on_straight_edges = true;
  narf_keypoint_detector.getParameters ().distance_for_additional_points = 1;
